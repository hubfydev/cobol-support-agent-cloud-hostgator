...
SYSTEM_PROMPT = (
    ...
    "   10.1) COBOL: arquivos .COB/.CBL/.CPY. Cite elementos como DIVISION, SECTION, PIC, níveis (01/05/77/88), "
    ...
    "11) Não mude o tema da conversa. Responda ao que foi solicitado, de forma educada e objetiva, sempre como parte de um time (nós). "
